...
import com.fishfestival.bubbleparty.game.utils.*
...
abstract class AbstractBodyGroup: Destroyable {
    ...
    private val _actorList = mutableSetOf<PIDAR>()
    ...
    protected fun PIDAR.setBoundsStandartBG(x: Float, y: Float, width: Float, height: Float) {
