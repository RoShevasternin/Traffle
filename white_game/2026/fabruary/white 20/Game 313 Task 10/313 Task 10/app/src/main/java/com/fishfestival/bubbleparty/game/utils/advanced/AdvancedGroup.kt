...
abstract class AdvancedGroup : WidgetGroup(), Disposable {
    ...
    val Vector2.toActual get() = sizeScaler.scaled(this)
    val Vector2.toDesign get() = sizeScaler.scaledInverse(this)
    val Float.toActual   get() = sizeScaler.scaled(this)
    val Float.toDesign   get() = sizeScaler.scaledInverse(this)
