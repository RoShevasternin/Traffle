...
const val WIDTH_WORLD  = 9f
const val HEIGHT_WORLD = 16f

const val METER_UI = WIDTH_UI / WIDTH_WORLD

val Vector2.scaledToB2 get() = this.divOr(METER_UI, 1f) // convert UI to Box2d
val Vector2.scaledToUI get() = this.scl(METER_UI) // convert Box2d to UI
val Float.scaledToB2 get() = this.divOr(METER_UI, 1f) // convert UI to Box2d
...
const val TIME_ANIM_SCREEN = 0.24f
