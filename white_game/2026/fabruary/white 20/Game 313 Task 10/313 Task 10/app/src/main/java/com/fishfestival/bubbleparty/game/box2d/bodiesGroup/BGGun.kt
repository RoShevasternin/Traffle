package com.fishfestival.bubbleparty.game.box2d.bodiesGroup
...
import com.fishfestival.bubbleparty.game.box2d.AbstractBodyGroup
import com.fishfestival.bubbleparty.game.box2d.AbstractJoint
import com.fishfestival.bubbleparty.game.box2d.BodyId
import com.fishfestival.bubbleparty.game.box2d.bodies.BBall
import com.fishfestival.bubbleparty.game.box2d.bodies.BBomb
import com.fishfestival.bubbleparty.game.box2d.bodies.BGun
import com.fishfestival.bubbleparty.game.box2d.bodies.standart.BDynamic
import com.fishfestival.bubbleparty.game.box2d.bodies.standart.BStatic
import com.fishfestival.bubbleparty.game.utils.DEGTORAD
import com.fishfestival.bubbleparty.game.utils.RADTODEG
...
import com.fishfestival.bubbleparty.game.utils.scaledToB2
...
class BGGun(
    ...
    override fun create(x: Float, y: Float, w: Float, h: Float) {
        ...
        screenBox2d.stageWorld.addListener(getInputListener())
    ...
    private fun createJ_Gun() {
        jRevolute.create(RevoluteJointDef().apply {
            ...
            localAnchorA.set(Vector2(440f, 80f).subCenter(bodyA))
    ...
    fun preparationBomb(bgBomb: BGBomb) {
        ...
        bGun.preparation(gdxGame.assetsAll.BOMB.region)
    }
...
//            log("angle Gun: ${resultAngle * RADTODEG} | $resultAngle")
        ...
        private fun playSound_TouchDown() {
            if (currentTimeMinus(timeTouchDown) >= 100) {
                gdxGame.soundUtil.apply { play(load_of_big_gun_fun, 0.6f) }
                timeTouchDown = System.currentTimeMillis()
            }
        }

        private fun playSound_TouchUp() {
            if (currentTimeMinus(timeTouchDown) >= 250) gdxGame.soundUtil.apply { play(shot_of_big_gun_fun) }
        }
