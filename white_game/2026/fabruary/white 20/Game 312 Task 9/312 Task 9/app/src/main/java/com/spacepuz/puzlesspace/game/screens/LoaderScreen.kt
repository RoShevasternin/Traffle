...
import com.spacepuz.puzlesspace.game.actors.AMainLoader
import com.spacepuz.puzlesspace.game.manager.MusicManager
...
import com.spacepuz.puzlesspace.game.utils.HEIGHT_UI
import com.spacepuz.puzlesspace.game.utils.TIME_ANIM_SCREEN
import com.spacepuz.puzlesspace.game.utils.WIDTH_UI
...
class LoaderScreen : AdvancedScreen() {
    ...
    private fun isFinish() {
        if (isFinishProgress) {
            ...
            gdxGame.musicUtil.apply { currentMusic = FASADE.apply {
                isLooping = true
                coff      = 0.42f
            } }
