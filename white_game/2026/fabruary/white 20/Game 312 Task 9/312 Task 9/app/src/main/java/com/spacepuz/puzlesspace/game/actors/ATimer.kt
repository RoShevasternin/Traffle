...
import com.spacepuz.puzlesspace.game.utils.font.FontParameter

class ATimer(override val screen: AdvancedScreen): AdvancedGroup() {

    private val params = FontParameter().setCharacters(FontParameter.CharType.NUMBERS).setSize(69)
    ...
    private val label      = Label("60", labelStyle)
    ...
    private fun updateLabel() {
        ...
        // Форматуємо в 00:00
        label.setText(String.format("%02d", sec))
    }
