package com.circuser.pairante.game.actors.checkbox
...
import com.circuser.pairante.game.utils.TextureEmpty
import com.circuser.pairante.game.utils.actor.addAndFillActors
...
open class ACheckBox(
    ...
    fun getStyleByType(type: Type) = when(type) {
        Type.CHECK -> ACheckBoxStyle(
            ...
            checked = TextureRegionDrawable(gdxGame.assetsAll.GALCA),
        )
    }
