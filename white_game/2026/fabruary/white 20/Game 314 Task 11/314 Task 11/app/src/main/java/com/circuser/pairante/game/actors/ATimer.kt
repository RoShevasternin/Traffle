...
import com.circuser.pairante.game.utils.font.FontParameter

class ATimer(override val screen: AdvancedScreen): AdvancedGroup() {

    private val params = FontParameter().setCharacters(FontParameter.CharType.NUMBERS.chars + ":").setSize(65)
    private val font   = screen.fontGenerator_Hanuman_Regular.generateFont(params)

    private val labelStyle = Label.LabelStyle(font, Color.valueOf("C30771"))
