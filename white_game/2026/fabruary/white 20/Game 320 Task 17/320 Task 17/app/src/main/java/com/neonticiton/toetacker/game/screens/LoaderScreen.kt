...
import com.neonticiton.toetacker.game.actors.AMainLoader
import com.neonticiton.toetacker.game.manager.MusicManager
import com.neonticiton.toetacker.game.manager.SoundManager
import com.neonticiton.toetacker.game.manager.SpriteManager
import com.neonticiton.toetacker.game.utils.Block
import com.neonticiton.toetacker.game.utils.HEIGHT_UI
import com.neonticiton.toetacker.game.utils.TIME_ANIM_SCREEN
import com.neonticiton.toetacker.game.utils.WIDTH_UI
...
class LoaderScreen : AdvancedScreen() {
    ...
    private fun isFinish() {
        if (isFinishProgress) {
            ...
            gdxGame.musicUtil.apply { currentMusic = GAME.apply {
                isLooping = true
                coff      = 0.77f
            } }
