package com.pyramidconnect.sorting.game.actors.checkbox
...
open class ACheckBox(
    ...
    fun getStyleByType(type: Type) = when(type) {
        Type.VIBRO -> ACheckBoxStyle(
            default = TextureRegionDrawable(gdxGame.assetsAll.VIBRO_DEF),
            checked = TextureRegionDrawable(gdxGame.assetsAll.VIBRO_CHECK),
        )
    }
