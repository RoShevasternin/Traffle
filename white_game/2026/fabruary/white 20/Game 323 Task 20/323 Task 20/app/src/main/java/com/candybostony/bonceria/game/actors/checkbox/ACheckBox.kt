package com.candybostony.bonceria.game.actors.checkbox
...
open class ACheckBox(
    ...
    fun getStyleByType(type: Type) = when(type) {
        Type.OFF_ON -> ACheckBoxStyle(
            default = TextureRegionDrawable(gdxGame.assetsAll.OFF),
            checked = TextureRegionDrawable(gdxGame.assetsAll.ON),
        )
    }
