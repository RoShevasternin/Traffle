package com.bounceques.ternationaret.game.actors.button
...
open class AButton(
    ...
    private val assets by lazy { screen.game.assetsAll }
    ...
    private fun getStyleByType(type: Static.Type) = when(type) {
        Static.Type.BACK -> Static.AButtonStyle(
            default = TextureRegionDrawable(assets.BD),
            pressed = TextureRegionDrawable(assets.BP),
            disabled = TextureRegionDrawable(assets.BP),
        )
        Static.Type.LEFT -> Static.AButtonStyle(
            default = TextureRegionDrawable(assets.LEFT_DEF),
            pressed = TextureRegionDrawable(assets.LEFT_PRESS),
            disabled = TextureRegionDrawable(assets.LEFT_PRESS),
        )
        Static.Type.RIGHT -> Static.AButtonStyle(
            default = TextureRegionDrawable(assets.RIGHT_DEF),
            pressed = TextureRegionDrawable(assets.RIGHT_PRESS),
            disabled = TextureRegionDrawable(assets.RIGHT_PRESS),
        )
        Static.Type.UP -> Static.AButtonStyle(
            default = TextureRegionDrawable(assets.UP_DEF),
            pressed = TextureRegionDrawable(assets.UP_PRESS),
            disabled = TextureRegionDrawable(assets.UP_PRESS),
        )
    }
