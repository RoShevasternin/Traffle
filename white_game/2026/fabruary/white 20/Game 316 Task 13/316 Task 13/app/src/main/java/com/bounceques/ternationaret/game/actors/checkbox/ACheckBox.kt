...
open class ACheckBox(
    ...
    fun getStyleByType(type: Static.Type) = when(type) {
        Static.Type.MUSIC -> Static.ACheckBoxStyle(
            default = TextureRegionDrawable(screen.game.assetsAll.MD),
            checked = TextureRegionDrawable(screen.game.assetsAll.MP),
        )
        Static.Type.SOUND -> Static.ACheckBoxStyle(
            default = TextureRegionDrawable(screen.game.assetsAll.SD),
            checked = TextureRegionDrawable(screen.game.assetsAll.SP),
        )
    }
