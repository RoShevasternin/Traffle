package com.babun.flutterdash.game.actors.checkbox
...
import com.babun.flutterdash.game.utils.actor.addAndFillActors
...
open class ACheckBox(
    ...
    fun getStyleByType(type: Type) = when(type) {
        Type.PAUSE -> ACheckBoxStyle(
            default = TextureRegionDrawable(gdxGame.assetsAll.PAUSE),
            checked = TextureRegionDrawable(gdxGame.assetsAll.PLAY),
        )
        Type.HART -> ACheckBoxStyle(
            default = TextureRegionDrawable(gdxGame.assetsAll.HART_DEF),
            checked = TextureRegionDrawable(gdxGame.assetsAll.HART_CHECK),
        )
    }
