package com.skynebowow.runnerblue.game.actors.button
...
open class AButton(
    ...
    private fun getStyleByType(type: Static.Type) = when(type) {
        Static.Type.PLAY -> Static.AButtonStyle(
            default = TextureRegionDrawable(assets.PL_DEF),
            pressed = TextureRegionDrawable(assets.PL_PRESS),
            disabled = TextureRegionDrawable(assets.PL_PRESS),
        )
        Static.Type.EXIT -> Static.AButtonStyle(
            default = TextureRegionDrawable(assets.EXIT_DEF),
            pressed = TextureRegionDrawable(assets.EXIT_PRESS),
            disabled = TextureRegionDrawable(assets.EXIT_PRESS),
        )
        Static.Type.SHOP -> Static.AButtonStyle(
            default = TextureRegionDrawable(assets.SHOP_DEF),
            pressed = TextureRegionDrawable(assets.SHOP_PRESS),
            disabled = TextureRegionDrawable(assets.SHOP_PRESS),
        )
        Static.Type.BACK -> Static.AButtonStyle(
            default = TextureRegionDrawable(assets.BEC_DEF),
            pressed = TextureRegionDrawable(assets.BEC_PRESS),
            disabled = TextureRegionDrawable(assets.BEC_PRESS),
        )
        Static.Type.RULES -> Static.AButtonStyle(
            default = TextureRegionDrawable(assets.RL_DEF),
            pressed = TextureRegionDrawable(assets.RL_PRESS),
            disabled = TextureRegionDrawable(assets.RL_PRESS),
        )
    }
