package com.oceanstar.ballduinstar.game.actors.checkbox
...
import com.oceanstar.ballduinstar.game.utils.actor.addAndFillActors
...
import com.oceanstar.ballduinstar.game.utils.region
...
open class ACheckBox(
    ...
    fun getStyleByType(type: Type) = when(type) {
        Type.MUSIC -> ACheckBoxStyle(
            default = gdxGame.assetsAll.MD.region,
            checked = gdxGame.assetsAll.MP.region,
        )
        Type.ON_OFF -> ACheckBoxStyle(
            default = gdxGame.assetsAll.ON.region,
            checked = gdxGame.assetsAll.OFF.region,
        )
    }
