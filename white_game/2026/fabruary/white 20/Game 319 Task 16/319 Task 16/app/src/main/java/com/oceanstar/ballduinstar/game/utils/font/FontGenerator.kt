package com.oceanstar.ballduinstar.game.utils.font
...
class FontGenerator(fontPath: FontPath): FreeTypeFontGenerator(Gdx.files.internal(fontPath.path)) {
    ...
    companion object {
        enum class FontPath(val path: String) {
            AsapCondensed_Regular("font/AsapCondensed-Regular.ttf"),
            AsapCondensed_SemiBold("font/AsapCondensed-SemiBold.ttf"),
        }
    }
