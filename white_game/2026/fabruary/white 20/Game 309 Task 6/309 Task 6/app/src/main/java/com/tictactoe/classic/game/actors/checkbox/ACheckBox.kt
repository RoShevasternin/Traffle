package com.tictactoe.classic.game.actors.checkbox
...
open class ACheckBox(
    ...
    fun getStyleByType(type: Type) = when(type) {
        Type.SOUND -> ACheckBoxStyle(
            default = TextureRegionDrawable(gdxGame.assetsAll.SOUND_DEF),
            checked = TextureRegionDrawable(gdxGame.assetsAll.SOUND_PRESS),
        )
    }
