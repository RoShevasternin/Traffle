...
class LoseScreen: AdvancedScreen() {
    ...
    override fun show() {
        gdxGame.soundUtil.apply { play(fail_game) }
        setBackBackground(gdxGame.assetsAll.RED)
        super.show()
        animShowScreen()
    }
    ...
    private fun Group.addGroup() {
        ...
        group.apply {
            ...
            val aM = Actor()
            addActors(aN, aM)
            aN.setBounds(87f, 204f, 631f, 202f)
            aM.setBounds(145f, 0f, 516f, 165f)
