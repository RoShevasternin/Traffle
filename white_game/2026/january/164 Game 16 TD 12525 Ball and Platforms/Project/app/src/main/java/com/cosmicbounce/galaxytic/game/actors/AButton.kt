...
open class AButton(
    ...
    private fun getStyleByType(type: Static.Type) = when(type) {
        Static.Type.Begin -> Static.AButtonStyle(
            default  = TextureRegionDrawable(screen.game.all.bgd),
            pressed  = TextureRegionDrawable(screen.game.all.bgp),
            disabled = TextureRegionDrawable(screen.game.all.bgp),
        )
        Static.Type.Exit -> Static.AButtonStyle(
            default  = TextureRegionDrawable(screen.game.all.extd),
            pressed  = TextureRegionDrawable(screen.game.all.extp),
            disabled = TextureRegionDrawable(screen.game.all.extp),
        )
        Static.Type.Settongs -> Static.AButtonStyle(
            default  = TextureRegionDrawable(screen.game.all.std),
            pressed  = TextureRegionDrawable(screen.game.all.stp),
            disabled = TextureRegionDrawable(screen.game.all.stp),
        )
        Static.Type.Back -> Static.AButtonStyle(
            default  = TextureRegionDrawable(screen.game.all.bkd),
            pressed  = TextureRegionDrawable(screen.game.all.bkp),
            disabled = TextureRegionDrawable(screen.game.all.bkp),
        )
        Static.Type.Info -> Static.AButtonStyle(
            default  = TextureRegionDrawable(screen.game.all.infd),
            pressed  = TextureRegionDrawable(screen.game.all.infp),
            disabled = TextureRegionDrawable(screen.game.all.infp),
        )
        Static.Type.Nazad -> Static.AButtonStyle(
            default  = TextureRegionDrawable(screen.game.all.backdef),
            pressed  = TextureRegionDrawable(screen.game.all.backprss),
            disabled = TextureRegionDrawable(screen.game.all.backprss),
        )
        Static.Type.Agree -> Static.AButtonStyle(
            default  = TextureRegionDrawable(screen.game.all.agd),
            pressed  = TextureRegionDrawable(screen.game.all.agp),
            disabled = TextureRegionDrawable(screen.game.all.agp),
        )
    }
    ...
    object Static {
        ...
        enum class Type {
            Begin, Settongs, Info, Exit, Back, Nazad, Agree
        }
    }
