...
open class AButton(
    ...
    private fun getStyleByType(type: Static.Type) = when(type) {
        Static.Type.Give -> Static.AButtonStyle(
            default  = TextureRegionDrawable(screen.game.all.ga_df),
            pressed  = TextureRegionDrawable(screen.game.all.ga_ps),
            disabled = TextureRegionDrawable(screen.game.all.ga_ps),
        )
        Static.Type.Exit -> Static.AButtonStyle(
            default  = TextureRegionDrawable(screen.game.all.ex_df),
            pressed  = TextureRegionDrawable(screen.game.all.ex_ps),
            disabled = TextureRegionDrawable(screen.game.all.ex_ps),
        )
        Static.Type.Rules -> Static.AButtonStyle(
            default  = TextureRegionDrawable(screen.game.all.rc_df),
            pressed  = TextureRegionDrawable(screen.game.all.rc_ps),
            disabled = TextureRegionDrawable(screen.game.all.rc_ps),
        )
        Static.Type.View -> Static.AButtonStyle(
            default  = TextureRegionDrawable(screen.game.all.vc_df),
            pressed  = TextureRegionDrawable(screen.game.all.vc_ps),
            disabled = TextureRegionDrawable(screen.game.all.vc_ps),
        )
        Static.Type.Menu -> Static.AButtonStyle(
            default  = TextureRegionDrawable(screen.game.all.mn_df),
            pressed  = TextureRegionDrawable(screen.game.all.mn_ps),
            disabled = TextureRegionDrawable(screen.game.all.mn_ps),
        )
        Static.Type.Arg -> Static.AButtonStyle(
