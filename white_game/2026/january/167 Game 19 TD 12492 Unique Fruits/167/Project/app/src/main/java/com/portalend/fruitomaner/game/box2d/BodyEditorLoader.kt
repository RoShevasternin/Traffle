...
class BodyEditorLoader {
    ...
    val internalModel: com.portalend.fruitomaner.game.box2d.BodyEditorLoader.Model
    ...
    // -------------------------------------------------------------------------
    class Model {
        val rigidBodies: MutableMap<String?, com.portalend.fruitomaner.game.box2d.BodyEditorLoader.RigidBodyModel> = HashMap()
    }
    ...
    class RigidBodyModel {
        ...
        val origin = Vector2()
        val polygons: MutableList<com.portalend.fruitomaner.game.box2d.BodyEditorLoader.PolygonModel> = ArrayList()
        val circles: MutableList<com.portalend.fruitomaner.game.box2d.BodyEditorLoader.CircleModel> = ArrayList()
    ...
    // -------------------------------------------------------------------------
    private fun readJson(str: String): com.portalend.fruitomaner.game.box2d.BodyEditorLoader.Model {
        val m = com.portalend.fruitomaner.game.box2d.BodyEditorLoader.Model()
    ...
    private fun readRigidBody(bodyElem: JsonValue): com.portalend.fruitomaner.game.box2d.BodyEditorLoader.RigidBodyModel {
        val rbModel = com.portalend.fruitomaner.game.box2d.BodyEditorLoader.RigidBodyModel()
        ...
        while (polygonsElem != null) {
            val polygon = com.portalend.fruitomaner.game.box2d.BodyEditorLoader.PolygonModel()
        ...
        while (circleElem != null) {
            val circle = com.portalend.fruitomaner.game.box2d.BodyEditorLoader.CircleModel()
