...
import com.greciao.candyrocket.game.actors.AResultGroup
import com.greciao.candyrocket.game.actors.ATimerGroup
import com.greciao.candyrocket.game.box2d.AbstractBody
import com.greciao.candyrocket.game.box2d.AbstractJoint
import com.greciao.candyrocket.game.box2d.BodyId
import com.greciao.candyrocket.game.box2d.bodies.BAvia
import com.greciao.candyrocket.game.box2d.bodies.BCoin
import com.greciao.candyrocket.game.box2d.bodies.BEnemy
import com.greciao.candyrocket.game.box2d.bodies.standart.BStatic
...
import com.greciao.candyrocket.game.utils.advanced.AdvancedMouseScreen
...
import com.greciao.candyrocket.game.utils.toB2
...
import com.greciao.candyrocket.game.utils.WIDTH_BOX2D
...
class GameScreen(override val game: LibGDXGame) : AdvancedMouseScreen(game) {
    ...
    override fun show() {
        ...
        setBackBackground(game.allAssets.background_game.region)
        super.show()
    ...
    override fun AdvancedStage.addActorsOnStageUI() {
        ...
        aTimer.startTimer {
            ...
            aResult.update(true, CANONcoinCount)
                ...
                BodyId.Game.ENEMY -> {
                    ...
                    if (b2.atomicBoolean.getAndSet(false)) {
                        ...
                        if (hartCount == 3) {
                            ...
                            aResult.update(false, CANONcoinCount)
                            aResult.animShow(TIME_ANIM_SCREEN_ALPHA)
                            aResult.touchable = Touchable.enabled
                        }
