...
class SpriteManager(var assetManager: AssetManager) {
    ...
    enum class EnumTexture(val data: TextureData) {
        ...
        game_background(TextureData("textures/all/background_game.png")),
        ase(TextureData("textures/ase.png")),
        new_l(TextureData("textures/all/new_l.png")),
        new_w(TextureData("textures/all/new_w.png")),
    }
