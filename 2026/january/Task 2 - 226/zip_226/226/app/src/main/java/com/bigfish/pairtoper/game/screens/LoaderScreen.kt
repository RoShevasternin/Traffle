...
import com.bigfish.pairtoper.game.GDX_GLOBAL_isGame
import com.bigfish.pairtoper.game.GDX_GLOBAL_isLoadAssets
import com.bigfish.pairtoper.game.actors.main.AMainLoader
...
import com.bigfish.pairtoper.game.utils.*
...
class LoaderScreen : AdvancedScreen() {
    ...
    private fun toGame() {
        ...
        gdxGame.musicUtil.apply { currentMusic = fishka.apply {
            isLooping = true
            coff      = 0.23f
        } }
