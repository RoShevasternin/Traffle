package com.baldasari.munish.cards.game.utils.advanced
...
import com.baldasari.munish.cards.game.utils.HEIGHT_UI
import com.baldasari.munish.cards.game.utils.ShapeDrawerUtil
import com.baldasari.munish.cards.game.utils.TIME_ANIM
import com.baldasari.munish.cards.game.utils.WIDTH_UI
import com.baldasari.munish.cards.game.utils.actor.animHide
import com.baldasari.munish.cards.game.utils.addProcessors
import com.baldasari.munish.cards.game.utils.disposeAll
import com.baldasari.munish.cards.game.utils.font.FontGenerator
import com.baldasari.munish.cards.util.cancelCoroutinesAll
...
abstract class AdvancedScreen(
    ...
    val fontGenerator_LuckiestGuy = FontGenerator(FontGenerator.Companion.FontPath.LuckiestGuy)
    val fontGenerator_Lustria = FontGenerator(FontGenerator.Companion.FontPath.Lustria)
...
//        Gdx.input.setCatchKey(Input.Keys.BACK, true)
    ...
    override fun dispose() {
        ...
        disposeAll(
            ...
            fontGenerator_LuckiestGuy,
            fontGenerator_Lustria,
        )
