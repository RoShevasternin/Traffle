...
import com.pink.plinuirtaster.game.utils.toUI
...
class AbstractJoint<T : Joint, TD : JointDef>(val screenBox2d: AdvancedBox2dScreen): Destroyable {
    ...
    fun drawJoint(alpha: Float) = joint?.run { screenBox2d.drawerUtil.drawer.line(anchorA.toUI, anchorB.toUI, colorJoint.apply { a = alpha }, 1f) }
