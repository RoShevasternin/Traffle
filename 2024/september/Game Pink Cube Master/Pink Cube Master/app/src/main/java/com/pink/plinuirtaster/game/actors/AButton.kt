...
open class AButton(
    ...
    private fun getStyleByType(type: Static.Type) = when(type) {
        ...
        Static.Type.Start -> Static.AButtonStyle(
            ...
            pressed  = TextureRegionDrawable(screen.game.all.START_PRS),
            disabled = TextureRegionDrawable(screen.game.all.START_PRS),
        )
        Static.Type.Completed -> Static.AButtonStyle(
            default  = TextureRegionDrawable(screen.game.all.COMPLETED_DEF),
            pressed  = TextureRegionDrawable(screen.game.all.COMPLETED_PRS),
            disabled = TextureRegionDrawable(screen.game.all.COMPLETED_PRS),
        )
    ...
    object Static {
        ...
        enum class Type {
            Play, Start, Completed, Back, Plus
        }
    }
