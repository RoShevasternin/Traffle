...
class CharacterScreen(override val game: LibGDXGame) : AdvancedScreen() {

    private val imgCard = Image(game.all.character_card)
    ...
    private fun AdvancedStage.addImgCard() {
        ...
        imgCard.setOnClickListener {
            ...
            stageUI.root.animHideScreen(TIME_ANIM) {
                game.navigationManager.navigate(CharacterShowScreen::class.java.name)
            }
        }
    }
