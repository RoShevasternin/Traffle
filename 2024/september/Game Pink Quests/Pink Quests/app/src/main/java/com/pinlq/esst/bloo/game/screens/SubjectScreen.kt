...
class SubjectScreen(override val game: LibGDXGame) : AdvancedScreen() {

    private val imgCard = Image(game.all.subject_card)
    ...
    private fun AdvancedStage.addImgCard() {
        ...
        imgCard.setOnClickListener {
            ...
            stageUI.root.animHideScreen(TIME_ANIM) {
                game.navigationManager.navigate(SubjectShowScreen::class.java.name)
            }
        }
    }
