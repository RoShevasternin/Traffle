package com.pinlq.esst.bloo.game.actors.checkbox
...
import com.pinlq.esst.bloo.game.utils.TextureEmpty
...
open class ACheckBox(
    ...
    open fun getListener() = object : InputListener() {
        ...
        override fun touchDown(event: InputEvent?, x: Float, y: Float, pointer: Int, button: Int): Boolean {
            ...
            screen.game.soundUtil.apply { play(this.CLICK) }
            return true
        }
    ...
    fun getStyleByType(type: Static.Type) = when(type) {
        Static.Type.CHECKER -> Static.ACheckBoxStyle(
