package com.shoote.maniapink.game.actors.checkbox
...
import com.roshevasternin.rozval.game.actors.checkbox.ACheckBoxGroup
import com.shoote.maniapink.game.utils.TextureEmpty
...
open class ACheckBox(
    ...
    open fun getListener() = object : InputListener() {
        ...
        override fun touchDown(event: InputEvent?, x: Float, y: Float, pointer: Int, button: Int): Boolean {
            ...
            screen.game.soundUtil.apply { play(click, 0.5f) }
            return true
        }
    ...
    fun getStyleByType(type: Type) = when(type) {
        Type.CHECK -> ACheckBoxStyle(
            ...
            checked = screen.game.all.check.region,
        )
    }
