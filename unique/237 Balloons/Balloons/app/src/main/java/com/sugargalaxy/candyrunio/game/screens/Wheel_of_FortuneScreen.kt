package com.sugargalaxy.candyrunio.game.screens

import com.badlogic.gdx.math.Interpolation
import com.badlogic.gdx.scenes.scene2d.actions.Actions
import com.badlogic.gdx.scenes.scene2d.ui.Image
import com.sugargalaxy.candyrunio.game.actors.ABackground
import com.sugargalaxy.candyrunio.game.actors.main.AMainWheel_of_Fortune
import com.sugargalaxy.candyrunio.game.utils.Block
import com.sugargalaxy.candyrunio.game.utils.HEIGHT_UI
import com.sugargalaxy.candyrunio.game.utils.TIME_ANIM_SCREEN
import com.sugargalaxy.candyrunio.game.utils.WIDTH_UI
import com.sugargalaxy.candyrunio.game.utils.actor.disable
import com.sugargalaxy.candyrunio.game.utils.actor.setBoundsScaled
import com.sugargalaxy.candyrunio.game.utils.advanced.AdvancedMainScreen
import com.sugargalaxy.candyrunio.game.utils.advanced.AdvancedStage
...
class Wheel_of_FortuneScreen: AdvancedMainScreen() {
    ...
    private val imgGorilla       = Image(gdxGame.assetsAll.NEW_SHAR)
    ...
    private fun AdvancedStage.addImgGorilla() {
        addActor(imgGorilla)
        imgGorilla.setBoundsScaled(sizeScalerScreen, -233f, -97f, 1057f, 1057f)
        imgGorilla.disable()
