...
class APanelBet(
    ...
    private val ls70 = Label.LabelStyle(font70, GameColor.black_09)
    ...
    private val btnMinus  = AButton(screen, AButton.Type.Minus)
    ...
    private fun addLblBet() {
        addActor(lblBet)
        lblBet.setBounds(248f, 45f, 249f, 61f)
    ...
    private fun addBtnMinusPlus() {
        ...
        btnMinus.apply {
            setBounds(141f, 42f, 114f, 107f)
            setOnClickListener { handlerMinus() }
        }
        btnPlus.apply {
            setBounds(497f, 42f, 114f, 107f)
