package com.sugargalaxy.candyrunio.game.manager
...
class SpriteManager(var assetManager: AssetManager) {
    ...
    enum class EnumTexture(val data: TextureData) {
        ...
        NEW_ROULETTE_BACK        (TextureData("textures/all/new_roulette_back.png")),
        NEW_SHAR                 (TextureData("textures/all/new_shar.png")),
