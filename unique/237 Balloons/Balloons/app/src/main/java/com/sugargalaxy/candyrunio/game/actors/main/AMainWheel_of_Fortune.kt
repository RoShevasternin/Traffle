...
import com.sugargalaxy.candyrunio.game.actors.AGems
import com.sugargalaxy.candyrunio.game.actors.ARoulette
import com.sugargalaxy.candyrunio.game.actors.ASheen
...
import com.sugargalaxy.candyrunio.game.utils.actor.setOnClickListener
...
class AMainWheel_of_Fortune(
    ...
    private fun addImgPanelPrice() {
        ...
        imgPanelPrice.setBounds(453f, 711f, 578f, 319f)
    }

    private fun addBtnSpin() {
        addActor(btnSpin)
        btnSpin.setBounds(103f, 799f, 347f, 322f)
