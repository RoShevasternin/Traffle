package com.sugargalaxy.candyrunio.game.manager.util
...
class SpriteUtil {
     ...
     class All {
         ...
         val NEW_ROULETTE_BACK         = SpriteManager.EnumTexture.NEW_ROULETTE_BACK.data.texture
         val NEW_SHAR                  = SpriteManager.EnumTexture.NEW_SHAR.data.texture
