...
import com.sugargalaxy.candyrunio.game.actors.label.ALabel
...
class APanelLocation(override val screen: AdvancedScreen): AdvancedGroup() {
    ...
    private val ls70  = LabelStyle(font70, Color.valueOf("554AE7"))
    ...
    private fun addLblPercent() {
        addActor(lblPercent)
        lblPercent.setBounds(677f, 330f, 235f, 166f)
