...
import com.quantumplay.orbitcrasher.game.actors.ALoading
import com.quantumplay.orbitcrasher.game.actors.ALoadingLight
...
class AMainLoader(
    ...
    private fun addImgGorilla() {
        addActor(imgGorilla)
        imgGorilla.setBounds(-173f, 142f, 1349f, 1349f)
