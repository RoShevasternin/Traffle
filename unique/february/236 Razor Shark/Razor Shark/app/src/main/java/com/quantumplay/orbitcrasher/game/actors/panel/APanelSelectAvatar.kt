...
import com.quantumplay.orbitcrasher.game.actors.AStatusAvatar
...
import com.quantumplay.orbitcrasher.game.utils.GLOBAL_listDataAvatar
...
class APanelSelectAvatar(override val screen: AdvancedScreen): AdvancedGroup() {
    ...
    private fun addAStatusAvatar() {
        ...
        aStatusAvatar.setBounds(403f, 555f, 199f, 80f)
    }

    private fun addLblGoldPerHour() {
        addActor(lblGoldPerHour)
        lblGoldPerHour.setBounds(5f, 568f, 352f, 45f)
    }

    private fun addBtnBuyUse() {
        addActor(btnBuyUse)
        btnBuyUse.setBounds(164f, 270f, 213f, 151f)
    ...
    private fun addBtnLeftRight() {
        ...
        btnLeft.apply {
            setBounds(41f, 97f, 140f, 102f)
            setOnClickListener { handlerLeft() }
        }
        btnRight.apply {
            setBounds(366f, 97f, 140f, 102f)
    ...
    private fun addImgAvatar() {
        addActor(imgAvatar)
        imgAvatar.setBounds(82f, 707f, 377f, 377f)
    }
