package com.quantumplay.orbitcrasher.game.actors
...
class AInputText(
    ...
    private val textFieldStyle = TextField.TextFieldStyle().apply {
            ...
            fontColor  = Color.valueOf("D71C19")
            cursor     = TextureRegionDrawable(screen.drawerUtil.getTexture(Color.valueOf("D71C19")))
            selection  = TextureRegionDrawable(screen.drawerUtil.getTexture(Color.valueOf("3B3CB3").cpy().apply { a = 0.25f }))
        }
