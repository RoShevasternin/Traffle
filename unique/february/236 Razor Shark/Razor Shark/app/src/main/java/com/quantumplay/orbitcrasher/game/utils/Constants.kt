package com.quantumplay.orbitcrasher.game.utils

import com.quantumplay.orbitcrasher.game.data.DataAvatar
...
val GLOBAL_listDataLocation = listOf(
    DataLocation(0, 1000, 0, "Minefield Abyss",          List(27) { it + 1 }, PosSize(108f, 54f, 566f, 566f)), // Available

    DataLocation(1, 5000,   5,  "Razor Reef",            List(MAX_LEVEL_JACKPOT) { (it + 1) * 2 }, PosSize(108f, 54f, 566f, 566f)),
    DataLocation(2, 10_000, 10, "Sunken War Zone",       List(MAX_LEVEL_JACKPOT) { (it + 1) * 3 }, PosSize(108f, 54f, 566f, 566f)),
    DataLocation(3, 20_000, 20, "Volcanic Trench",       List(MAX_LEVEL_JACKPOT) { (it + 1) * 4 }, PosSize(108f, 54f, 566f, 566f)),
    DataLocation(4, 30_000, 30, "Treasure Catacombs",    List(MAX_LEVEL_JACKPOT) { (it + 1) * 5 }, PosSize(108f, 54f, 566f, 566f)),
    DataLocation(5, 40_000, 40, "Electric Current Zone", List(MAX_LEVEL_JACKPOT) { (it + 1) * 6 }, PosSize(108f, 54f, 566f, 566f)),
    DataLocation(6, 50_000, 50, "Shark Arena",           List(MAX_LEVEL_JACKPOT) { (it + 1) * 7 }, PosSize(108f, 54f, 566f, 566f)),
)
