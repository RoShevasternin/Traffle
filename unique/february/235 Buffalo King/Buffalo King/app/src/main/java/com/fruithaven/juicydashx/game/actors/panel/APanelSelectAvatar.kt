...
import com.fruithaven.juicydashx.game.actors.AStatusAvatar
...
import com.fruithaven.juicydashx.game.utils.GLOBAL_listDataAvatar
...
class APanelSelectAvatar(override val screen: AdvancedScreen): AdvancedGroup() {
    ...
    private fun addAStatusAvatar() {
        ...
        aStatusAvatar.setBounds(407f, 543f, 195f, 80f)
    }
