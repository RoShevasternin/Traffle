...
import com.fruithaven.juicydashx.game.actors.ALevelBlocked
...
import com.fruithaven.juicydashx.game.actors.panel.APanelIncreaseJackpot
import com.fruithaven.juicydashx.game.actors.panel.APanelLocation
import com.fruithaven.juicydashx.game.actors.panel.APanelMain
import com.fruithaven.juicydashx.game.actors.panel.APanelMaxBet
import com.fruithaven.juicydashx.game.actors.panel.APanelSelectLocation
...
import com.fruithaven.juicydashx.game.utils.MAX_LEVEL_JACKPOT
...
class AMainPlay(
    ...
    private fun addAPanelLocation() {
        ...
        aPanelLocation.setBounds(-5f, 384f, 1116f, 766f)
    }

    private fun addAPanelMaxBet() {
        addActor(aPanelMaxBet)
        aPanelMaxBet.setBounds(354f, 1420f, 701f, 221f)
    }
