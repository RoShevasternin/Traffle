...
import com.crystalpath.mystmazer.game.actors.AStatusAvatar
...
import com.crystalpath.mystmazer.game.utils.GLOBAL_listDataAvatar
...
class APanelSelectAvatar(override val screen: AdvancedScreen): AdvancedGroup() {
    ...
    private fun addAStatusAvatar() {
        ...
        aStatusAvatar.setBounds(373f, 560f, 224f, 101f)
    }

    private fun addLblGoldPerHour() {
        addActor(lblGoldPerHour)
        lblGoldPerHour.setBounds(56f, 564f, 211f, 49f)
    }
