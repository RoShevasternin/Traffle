...
class SlotFillManager(
    ...
    private fun fillMix() {
        ...
        slotList.onEachIndexed { index, slot -> slot.collectionSlotItemWin = matrix5x3Handler.generateSlot(index) }
    }
    ...
    private fun fillWin() {
        ...
        slotList.onEachIndexed { index, slot -> slot.collectionSlotItemWin = matrix5x3Handler.generateSlot(index) }
        glowList.onEachIndexed { index, glow -> glow.collectionIndexWin = matrix5x3Handler.generateGlow(index) }
