...
import com.moonarcade.starlabyrinth.game.utils.TextureEmpty
...
import com.moonarcade.starlabyrinth.game.utils.region

open class ClickableElement(
    ...
    var touchDownBlock   : ClickableElement.(x: Float, y: Float) -> Unit = { _, _ -> }
    var touchDraggedBlock: ClickableElement.(x: Float, y: Float) -> Unit = { _, _ -> }
    var touchUpBlock     : ClickableElement.(x: Float, y: Float) -> Unit = { _, _ -> }
