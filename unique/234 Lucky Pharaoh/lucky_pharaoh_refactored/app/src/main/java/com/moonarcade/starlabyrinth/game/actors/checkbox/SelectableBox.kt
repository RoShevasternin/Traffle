...
open class SelectableBox(
    ...
    var checkBoxGroup: SelectionGroup? = null
    ...
    open fun getListener() = object : InputListener() {
        ...
        override fun touchUp(event: InputEvent?, x: Float, y: Float, pointer: Int, button: Int) {
            ...
            com.moonarcade.starlabyrinth.util.log("dd = $touchPointDown | $touchPointUp")
            if (isWithin) {
    ...
    fun check(isInvokeCheckBlock: Boolean = true) {
        ...
        checkBoxGroup?.let {
            it.presentCheckedCheckBox?.uncheck()
            it.presentCheckedCheckBox = this
        }
