...
import com.fruithaven.juicydashx.game.actors.panel.APanelBet
import com.fruithaven.juicydashx.game.actors.panel.APanelMain
import com.fruithaven.juicydashx.game.actors.slots.ASlotGroup
...
import com.fruithaven.juicydashx.game.utils.actor.setBounds
...
class AMainGame(
    ...
    private val personagePosSize = listOf(
        PosSize(102f, 548f, 865f, 1262f),
        PosSize(272f, 759f, 798f, 1167f),
        PosSize(68f, 709f, 1011f, 1138f),
        PosSize(4f, 502f, 1146f, 1308f),
        PosSize(312f, 600f, 882f, 1167f),
        PosSize(248f, 504f, 994f, 1453f),
        PosSize(235f, 624f, 916f, 1137f),
    ...
    private fun addAPanelBet() {
        addActor(aPanelBet)
        aPanelBet.setBounds(294f, 102f, 701f, 219f)
    }

    private fun addASlotGroup() {
        addActor(aSlotGroup)
        aSlotGroup.setBounds(-34f, 521f, 1147f, 730f)
    }
