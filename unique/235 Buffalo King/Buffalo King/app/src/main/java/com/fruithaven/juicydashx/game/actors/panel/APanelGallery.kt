...
import com.fruithaven.juicydashx.game.actors.AOnePuzzle
import com.fruithaven.juicydashx.game.actors.AScrollPane
import com.fruithaven.juicydashx.game.actors.autoLayout.AHorizontalGroup
...
import com.fruithaven.juicydashx.game.actors.shader.ASaturationPuzzleGroup
...
class APanelGallery(override val screen: AdvancedScreen): AdvancedGroup() {
    ...
    private val listPuzzle = listOf(
        Puzzle("\"Aggressive Buffalo King\"", gdxGame.assetsAll.listPuzzle[0], 1000,  10 , 1 ),
        Puzzle("\"Alpha Wolf Warrior\"", gdxGame.assetsAll.listPuzzle[1], 2000,  20 , 2 ),
        Puzzle("\"Eagle of Fury\"", gdxGame.assetsAll.listPuzzle[2], 3000,  30 , 3 ),
        Puzzle("\"Savage Mountain Lion Hunt\"", gdxGame.assetsAll.listPuzzle[3], 4000,  40 , 4 ),
        Puzzle("\"Ancient Buffalo Totem\"", gdxGame.assetsAll.listPuzzle[4], 5000,  50 , 5 ),
        Puzzle("\"Twin Alpha Wolves\"", gdxGame.assetsAll.listPuzzle[5], 6000,  60 , 6 ),
        Puzzle("\"Flaming Buffalo\"", gdxGame.assetsAll.listPuzzle[6], 7000,  70 , 7 ),
        Puzzle("\"Dark Eagle Spirit\"", gdxGame.assetsAll.listPuzzle[7], 8000,  80 , 8 ),
        Puzzle("\"Golden Wolf King\"", gdxGame.assetsAll.listPuzzle[8], 9000,  90 , 9 ),
        Puzzle("\"Arena Buffalo Monster\"", gdxGame.assetsAll.listPuzzle[9], 10000, 100, 10),
    )
