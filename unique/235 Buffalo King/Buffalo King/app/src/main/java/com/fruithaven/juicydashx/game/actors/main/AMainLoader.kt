...
import com.fruithaven.juicydashx.game.actors.ALoading
import com.fruithaven.juicydashx.game.actors.ALoadingLight
...
class AMainLoader(
    ...
    private fun addImgGorilla() {
        addActor(imgGorilla)
        imgGorilla.setBounds(18f, -187f, 1589f, 1589f)
