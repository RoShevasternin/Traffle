...
import com.crystalpath.mystmazer.game.actors.AGems
import com.crystalpath.mystmazer.game.actors.ARoulette
import com.crystalpath.mystmazer.game.actors.ASheen
import com.crystalpath.mystmazer.game.actors.button.AButton
import com.crystalpath.mystmazer.game.actors.button.AButtonSpin
...
import com.crystalpath.mystmazer.game.utils.actor.setOnClickListener
...
class AMainWheel_of_Fortune(
    ...
    private fun addBtnSpin() {
        addActor(btnSpin)
        btnSpin.setBounds(462f, 604f, 363f, 373f)
