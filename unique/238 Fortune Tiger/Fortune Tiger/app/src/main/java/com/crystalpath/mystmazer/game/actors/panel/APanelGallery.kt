...
import com.crystalpath.mystmazer.game.actors.AOnePuzzle
import com.crystalpath.mystmazer.game.actors.AScrollPane
import com.crystalpath.mystmazer.game.actors.autoLayout.AHorizontalGroup
...
import com.crystalpath.mystmazer.game.actors.shader.ASaturationPuzzleGroup
...
class APanelGallery(override val screen: AdvancedScreen): AdvancedGroup() {
    ...
    private val listPuzzle = listOf(
        ...
        Puzzle("\"The Mighty Tiger’s Fortune\"",           gdxGame.assetsAll.listPuzzle[2], 3000,  30 , 3 ),
        Puzzle("\"Guardians of the Temple\"",                   gdxGame.assetsAll.listPuzzle[3], 4000,  40 , 4 ),
        Puzzle("\"The Golden Silk Fan\"",           gdxGame.assetsAll.listPuzzle[4], 5000,  50 , 5 ),
        Puzzle("\"Koi Pond Prosperity\"",               gdxGame.assetsAll.listPuzzle[5], 6000,  60 , 6 ),
        Puzzle("\"Neon Arena of Fate\"",             gdxGame.assetsAll.listPuzzle[6], 7000,  70 , 7 ),
        Puzzle("\"Flight of the Golden Phoenix\"",                 gdxGame.assetsAll.listPuzzle[7], 8000,  80 , 8 ),
        Puzzle("\"Storm over the Imperial Gate\"",                gdxGame.assetsAll.listPuzzle[8], 9000,  90 , 9 ),
        Puzzle("\"The Demon’s Roulette\"",                    gdxGame.assetsAll.listPuzzle[9], 10000, 100, 10),
    )
