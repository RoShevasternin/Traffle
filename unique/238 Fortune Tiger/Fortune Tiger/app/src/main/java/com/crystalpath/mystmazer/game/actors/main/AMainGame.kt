...
import com.crystalpath.mystmazer.game.actors.panel.APanelBet
import com.crystalpath.mystmazer.game.actors.panel.APanelMain
import com.crystalpath.mystmazer.game.actors.slots.ASlotGroup
...
class AMainGame(
    ...
    private fun addAPanelBet() {
        addActor(aPanelBet)
        aPanelBet.setBounds(-88f, -85f, 1256f, 617f)
    }
    ...
    private fun addBtnSpin() {
        addActor(btnSpin)
        btnSpin.setBounds(40f, -10f, 420f, 432f)
