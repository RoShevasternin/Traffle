...
import com.quantumplay.orbitcrasher.game.actors.shader.AMaskGroup
...
import com.quantumplay.orbitcrasher.game.utils.toMS
...
import com.quantumplay.orbitcrasher.game.utils.Layout.SlotGroup as LSG
...
class ASlotGroup(
    ...
    private fun addMask() {
        addActor(mask)
        mask.setBounds(58f, 195f-65, 1040f, 443f)
        mask.addSlotList()
    }
