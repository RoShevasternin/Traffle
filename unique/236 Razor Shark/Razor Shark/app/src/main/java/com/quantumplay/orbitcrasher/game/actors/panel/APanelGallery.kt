...
import com.quantumplay.orbitcrasher.game.actors.AOnePuzzle
import com.quantumplay.orbitcrasher.game.actors.AScrollPane
import com.quantumplay.orbitcrasher.game.actors.autoLayout.AHorizontalGroup
...
import com.quantumplay.orbitcrasher.game.actors.shader.ASaturationPuzzleGroup
...
class APanelGallery(override val screen: AdvancedScreen): AdvancedGroup() {
    ...
    private val listPuzzle = listOf(
        Puzzle("\"Alpha Shark\"",               gdxGame.assetsAll.listPuzzle[0], 1000,  10 , 1 ),
        Puzzle("\"Deep Sea Surf\"",             gdxGame.assetsAll.listPuzzle[1], 2000,  20 , 2 ),
        Puzzle("\"Last Dive\"",                 gdxGame.assetsAll.listPuzzle[2], 3000,  30 , 3 ),
        Puzzle("\"Treasure Guard\"",            gdxGame.assetsAll.listPuzzle[3], 4000,  40 , 4 ),
        Puzzle("\"King of the Abyss\"",         gdxGame.assetsAll.listPuzzle[4], 5000,  50 , 5 ),
        Puzzle("\"Jackpot Frenzy\"",            gdxGame.assetsAll.listPuzzle[5], 6000,  60 , 6 ),
        Puzzle("\"Neon Mutant Shark\"",         gdxGame.assetsAll.listPuzzle[6], 7000,  70 , 7 ),
        Puzzle("\"Gold Rush Depths\"",          gdxGame.assetsAll.listPuzzle[7], 8000,  80 , 8 ),
        Puzzle("\"Abyss Boss\"",                gdxGame.assetsAll.listPuzzle[8], 9000,  90 , 9 ),
        Puzzle("\"High Stakes Bite\"",          gdxGame.assetsAll.listPuzzle[9], 10000, 100, 10),
    )
