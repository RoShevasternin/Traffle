package com.vortemika208.lavrix.game.actors.button

import com.vortemika208.lavrix.game.manager.util.SoundUtil
...
import com.vortemika208.lavrix.game.utils.TextureEmpty
...
open class AButton(
    ...
    enum class Type {
        None, SETT, LOBBY, SHOP, PLAY, SPIN
    }
