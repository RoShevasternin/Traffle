package com.zentorix.nv.casino.game.screens
...
import com.zentorix.nv.casino.game.actors.ATmpGroup
import com.zentorix.nv.casino.game.actors.button.AButton
import com.zentorix.nv.casino.game.actors.checkbox.ACheckBox
import com.zentorix.nv.casino.game.actors.checkbox.ACheckBoxGroup
import com.zentorix.nv.casino.game.actors.masks.Mask
import com.zentorix.nv.casino.game.manager.GameDataStoreManager
import com.zentorix.nv.casino.game.screens.games.CarnavalCatScreen
import com.zentorix.nv.casino.game.screens.games.GatesOfOlympusScreen
import com.zentorix.nv.casino.game.screens.games.SweetBonanzaScreen
import com.zentorix.nv.casino.game.screens.games.TreasureSnipesScreen
...
import com.zentorix.nv.casino.game.utils.actor.disable
...
class MenuScreen(override val game: LibGDXGame): AdvancedScreen() {
    ...
    private val balanceLbl  = Label("Balance: ${game.balance.balanceFlow.value} $", Label.LabelStyle(font48, GameColor.a_D2A86F))
    ...
    private fun AdvancedStage.addLogoImg() {
        //addActor(logoImg)
        //logoImg. setBounds(267f, 886f, 1387f, 150f)
    }

    private fun AdvancedStage.addBalance() {
        addActor(balanceLbl)
        balanceLbl.apply {
            setBounds(683f, 932f, 485f, 58f)
    ...
    private fun AdvancedStage.addIcon() {
        runGDX {
            addActor(iconMask)
            iconMask.apply {
