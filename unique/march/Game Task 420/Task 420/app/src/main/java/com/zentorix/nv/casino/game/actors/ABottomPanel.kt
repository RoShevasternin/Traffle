...
import com.zentorix.nv.casino.game.utils.actor.enable
...
class ABottomPanel(override val screen: AdvancedScreen): AdvancedGroup() {
    ...
    private val text1 = "Place your bets!"
    private val text2 = "Good luck!"
    ...
    override fun addActorsOnGroup() {
        addAndFillActor(Image(screen.drawerUtil.getRegion(Color.valueOf("5D0062").apply { a = 0.55f })))
        addTextLbl()
        addCreditImg()
        addSoundCBox()
        addInfoBtn()
