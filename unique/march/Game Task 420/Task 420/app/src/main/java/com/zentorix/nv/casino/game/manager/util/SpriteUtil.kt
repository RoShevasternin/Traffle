package com.zentorix.nv.casino.game.manager.util
...
class SpriteUtil {
     ...
     class LoaderAssets {
          ...
          val prog_back = SpriteManager.EnumTexture.prog_back.data.texture
     ...
     class AllAssets {
          ...
          val bottom_panel              = SpriteManager.EnumTexture.bottom_panel.data.texture
