...
import com.zentorix.nv.casino.game.actors.progress.ASlotCityProgress
...
import com.zentorix.nv.casino.game.utils.actor.setBounds
...
import com.zentorix.nv.casino.game.utils.Layout.Splash as LS
...
class LoaderScreen(override val game: LibGDXGame) : AdvancedScreen() {
    ...
    override fun AdvancedStage.addActorsOnStageUI() {
        addActor(logoImg)
        logoImg.setBounds(403f, 192f, 1113f, 810f)
        addActor(backImg)
