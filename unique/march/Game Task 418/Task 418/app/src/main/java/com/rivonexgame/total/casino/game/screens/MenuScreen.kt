...
import com.rivonexgame.total.casino.game.actors.ATmpGroup
...
import com.rivonexgame.total.casino.game.actors.checkbox.ACheckBoxGroup
...
import com.rivonexgame.total.casino.game.screens.games.CarnavalCatScreen
import com.rivonexgame.total.casino.game.screens.games.GatesOfOlympusScreen
import com.rivonexgame.total.casino.game.screens.games.SweetBonanzaScreen
import com.rivonexgame.total.casino.game.screens.games.TreasureSnipesScreen
...
class MenuScreen(override val game: LibGDXGame): AdvancedScreen() {
    ...
    private val balanceLbl  = Label("${game.balance.balanceFlow.value}$", Label.LabelStyle(font48, GameColor.a_D2A86F))
