package com.bramlix.cas888.casino.game.screens

import com.badlogic.gdx.scenes.scene2d.Actor
import com.badlogic.gdx.scenes.scene2d.ui.Image
import com.badlogic.gdx.scenes.scene2d.ui.Label
import com.badlogic.gdx.utils.Align
import com.bramlix.cas888.casino.game.actors.button.AButton
import com.bramlix.cas888.casino.game.actors.button.AButtonStyle
import com.bramlix.cas888.casino.game.actors.label.ALabelStyle
import com.bramlix.cas888.casino.game.actors.label.spinning.SpinningLabel
import com.bramlix.cas888.casino.game.actors.slots.SpinResult
import com.bramlix.cas888.casino.game.actors.slots.slot3x3.SlotGroup
import com.bramlix.cas888.casino.game.manager.NavigationManager
import com.bramlix.cas888.casino.game.manager.SpriteManager
import com.bramlix.cas888.casino.game.util.*
import com.bramlix.cas888.casino.game.util.advanced.AdvancedScreen
import com.bramlix.cas888.casino.game.util.advanced.AdvancedStage
import com.bramlix.cas888.casino.game.util.listeners.toClickable
import kotlinx.coroutines.flow.MutableStateFlow
import kotlinx.coroutines.launch
import com.bramlix.cas888.casino.game.util.Layout.Game1 as LG1
...
class GameScreen1: AdvancedScreen(1280f, 727f) {
    ...
    private val lastWinText   = SpinningLabel("0", ALabelStyle.bowler_20_white)
    private val musicButton   = AButton(AButtonStyle.Game_1.music)

    private val sgImage  = Image(SpriteManager.GameRegion_1.SLOT_GROUP_1.region)
    private val horImage = Image(SpriteManager.GameRegion_1.PANEL_HOR.region)
    private val verImage = Image(SpriteManager.GameRegion_1.PANEL_VER.region)


    override fun show() {
        super.show()
        setBackBackground(SpriteManager.GameRegion_1.BACKGROUND.region)
    ...
    override fun AdvancedStage.addActorsOnStageUI() {
        addAndFillActor(sgImage)
        addActors(horImage, verImage)
        horImage.setBounds(307f, 25f, 765f, 47f)
        verImage.setBounds(1157f, 149f, 108f, 428f)
