...
import com.bramlix.cas888.casino.game.actors.slots.slot5x3.SlotGroup
...
import com.bramlix.cas888.casino.util.toMS
import kotlinx.coroutines.delay
import kotlinx.coroutines.flow.MutableStateFlow
import kotlinx.coroutines.launch
import com.bramlix.cas888.casino.game.util.Layout.Game3 as LG3
...
class GameScreen3 : AdvancedScreen(1280f, 863f) {
    ...
    private val menuButton   = Actor() //AButton(AButtonStyle.Game_3.menu)
    ...
    override fun show() {
        super.show()
        setBackBackground(SpriteManager.GameRegion_3.BACKGROUND.region)
    ...
    override fun AdvancedStage.addActorsOnStageUI() {
        addAndFillActor(Image(SpriteManager.GameRegion_3.SLOT_GROUP_3.region))

        addSlotGroup()

        val bottom = Image(SpriteManager.GameRegion_3.panel_last.region)
        addActor(bottom)
        bottom.setBounds(82f, 85f, 1115f, 307f)
...
//        }
    ...
    private fun updateBalance() {
        coroutine.launch {
            Balance.balanceFlow.collect { balance -> balanceLabel.setText("BALANCE: " + balance.transformToBalanceFormat() + FUN) }
        }
    }
