...
import com.bramlix.cas888.casino.game.actors.checkbox.ACheckBox
import com.bramlix.cas888.casino.game.actors.checkbox.ACheckBoxGroup
import com.bramlix.cas888.casino.game.actors.checkbox.ACheckBoxStyle
...
import com.bramlix.cas888.casino.game.actors.slots.slot6x4.SlotGroup
...
import com.bramlix.cas888.casino.game.util.Layout.Game2 as LG2
...
class GameScreen2 : AdvancedScreen(1274f, 821f) {
    ...
    override fun show() {
        super.show()
        setBackBackground(SpriteManager.GameRegion_2.BACKGROUND.region)
    ...
    override fun AdvancedStage.addActorsOnStageUI() {
        addAndFillActor(Image(SpriteManager.GameRegion_2.SLOT_GROUP_2.region))
