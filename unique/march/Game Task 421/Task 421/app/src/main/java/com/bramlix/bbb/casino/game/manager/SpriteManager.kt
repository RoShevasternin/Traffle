package com.bramlix.bbb.casino.game.manager
...
import com.bramlix.bbb.casino.game.util.region
...
object SpriteManager {
    ...
    enum class EnumTexture(override val data: TextureData): ITexture {
        LOADER_BACKGROUND( TextureData("textures/loader/background_def.png")),
        LOADER(            TextureData("textures/loader/loader.png")        ),


        BACKGROUND_MENU(TextureData("textures/background_menu.png")),
        ...
        SLOT_GROUP_1(TextureData("textures/slot_group_1.png")),
        SLOT_GROUP_2(TextureData("textures/slot_group_2.png")),
        SLOT_GROUP_3(TextureData("textures/slot_group_3.png")),
        panel_last(TextureData("textures/panel_last.png")),
    }

    enum class SplashRegion(override val region: TextureRegion): IRegion {
        LOADER_BACKGROUND(EnumTexture.LOADER_BACKGROUND.data.texture.region),
        LOADER           (EnumTexture.LOADER.data.texture.region),
    }

    enum class MenuRegion(override val region: TextureRegion): IRegion {
        BACKGROUND_MENU(EnumTexture.BACKGROUND_MENU.data.texture.region),
    ...
    enum class GameRegion_1(override val region: TextureRegion): IRegion {
        ...
        PANEL_HOR(          EnumAtlas.GAME1.data.atlas.findRegion("panel_hor")          ),
        PANEL_VER(          EnumAtlas.GAME1.data.atlas.findRegion("panel_ver")          ),
    }
    ...
    enum class GameRegion_2(override val region: TextureRegion): IRegion {
        ...
        SLOT_GROUP_2(EnumTexture.SLOT_GROUP_2.data.texture.region),
    ...
    enum class GameRegion_3(override val region: TextureRegion): IRegion {
        ...
        SLOT_GROUP_3(EnumTexture.SLOT_GROUP_3.data.texture.region),
        panel_last(EnumTexture.panel_last.data.texture.region),
