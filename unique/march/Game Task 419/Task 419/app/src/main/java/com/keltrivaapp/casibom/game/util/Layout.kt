...
object Layout {
    ...
    object Menu {
        ...
        val coinImage = LayoutData(118f, 382f, 1046f, 132f)
    ...
    object Game3 {
        ...
        val menu      = LayoutData(429f, 99f, 86f, 85f)
        val music     = LayoutData(115f, 90f, 19f, 19f)
        val musicArea = LayoutData(103f, 79f, 43f, 43f)
        val spin      = LayoutData(713f, 98f, 126f, 125f)
        val auto      = LayoutData(876f, 99f, 86f, 86f)
        val betText   = LayoutData(180f, 117f, 45f, 33f)
        val plus      = LayoutData(322f, 98f, 54f, 64f)
        val minus     = LayoutData(24f, 98f, 54f, 64f)
        val lastWin   = LayoutData(1020f, 119f, 218f, 33f)
