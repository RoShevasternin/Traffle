package com.keltrivaapp.casibom
...
import com.keltrivaapp.casibom.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity(), AndroidFragmentApplication.Callbacks {
    ...
    fun takePhoto(block: (Bitmap?) -> Unit) {
        ...
        requestPermission(android.Manifest.permission.CAMERA) { isGranted ->
