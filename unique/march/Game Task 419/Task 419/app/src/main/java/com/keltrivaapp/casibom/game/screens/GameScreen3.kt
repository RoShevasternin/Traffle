...
import com.keltrivaapp.casibom.game.actors.slots.slot5x3.SlotGroup
...
import com.keltrivaapp.casibom.util.toMS
import kotlinx.coroutines.delay
import kotlinx.coroutines.flow.MutableStateFlow
import kotlinx.coroutines.launch
import com.keltrivaapp.casibom.game.util.Layout.Game3 as LG3
...
class GameScreen3 : AdvancedScreen(1280f, 863f) {
    ...
    override fun AdvancedStage.addActorsOnStageUI() {
        ...
        addActor(bottom)
        bottom.setBounds(-27f, 93f, 1321f, 231f)
