...
//    }
    ...
    object BOWLERFont: IFont {
        ...
        override val font_48 = FontTTFData("BOWLER_48", getLoaderParameter(pathBOWLER) { size = 48 })
    ...
    interface IFont {
        ...
        val font_48: FontTTFData

        val values get() = listOf<FontTTFData>(font_15, font_20, font_25, font_30, font_40, font_48)
    }
