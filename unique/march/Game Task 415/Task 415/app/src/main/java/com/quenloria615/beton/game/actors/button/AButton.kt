package com.quenloria615.beton.game.actors.button
...
import com.quenloria615.beton.game.utils.TextureEmpty
import com.quenloria615.beton.game.utils.actor.addAndFillActors
...
open class AButton(
    ...
    private fun getStyleByType(type: Type) = when(type) {
        ...
        Type.LOBBY -> AButtonStyle(
            default  = TextureRegionDrawable(gdxGame.assetsAll.LOBBY_DEF),
            pressed  = TextureRegionDrawable(gdxGame.assetsAll.LOBBY_PRESS),
            disabled = TextureRegionDrawable(gdxGame.assetsAll.LOBBY_PRESS),
        )
        Type.SHOP -> AButtonStyle(
            default  = TextureRegionDrawable(gdxGame.assetsAll.SHOP_DEF),
            pressed  = TextureRegionDrawable(gdxGame.assetsAll.SHOP_PRESS),
            disabled = TextureRegionDrawable(gdxGame.assetsAll.SHOP_PRESS),
        )
        ...
        Type.GAIN -> AButtonStyle(
            default  = TextureRegionDrawable(gdxGame.assetsAll.GAIN_DEF),
            pressed  = TextureRegionDrawable(gdxGame.assetsAll.GAIN_PRESS),
            disabled = TextureRegionDrawable(gdxGame.assetsAll.GAIN_PRESS),
        )
    }
    ...
    enum class Type {
        None, SETT, LOBBY, SHOP, PLAY, SPIN, GAIN
    }
