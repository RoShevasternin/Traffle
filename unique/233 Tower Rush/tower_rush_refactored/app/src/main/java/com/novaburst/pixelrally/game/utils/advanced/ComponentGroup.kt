...
import com.novaburst.pixelrally.util.OneTime
import com.novaburst.pixelrally.util.cancelCoroutinesAll
import kotlinx.coroutines.CoroutineScope
import kotlinx.coroutines.Dispatchers

abstract class ComponentGroup : WidgetGroup(), Disposable {

    abstract val screen: DisplayScreen

    open val sizeScaler: DimensionCalculator = DimensionCalculator(DimensionCalculator.Axis.X)
    ...
    override fun draw(batch: Batch?, parentAlpha: Float) {
        preDrawArray.forEach { it.draw(parentAlpha * this@ComponentGroup.color.a) }
        super.draw(batch, parentAlpha)
        postDrawArray.forEach { it.draw(parentAlpha * this@ComponentGroup.color.a) }
    }
