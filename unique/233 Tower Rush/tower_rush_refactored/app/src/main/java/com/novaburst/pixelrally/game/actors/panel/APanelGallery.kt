...
import com.novaburst.pixelrally.game.actors.AOnePuzzle
import com.novaburst.pixelrally.game.actors.ScrollablePanel
import com.novaburst.pixelrally.game.actors.autoLayout.AHorizontalGroup
...
import com.novaburst.pixelrally.game.actors.shader.ASaturationPuzzleGroup
...
class APanelGallery(override val screen: DisplayScreen): ComponentGroup() {

    private val listPuzzle = listOf(
        Puzzle("\"Box Impact Puzzle\"",             gdxGame.assetsAll.listPuzzle[0], 1000,  10 , 1 ),
        Puzzle("\"Crane Chaos Puzzle\"",            gdxGame.assetsAll.listPuzzle[1], 2000,  20 , 2 ),
        Puzzle("\" Female Power Puzzle\"",          gdxGame.assetsAll.listPuzzle[2], 3000,  30 , 3 ),
        Puzzle("\"Warehouse Collapse Puzzle\"",     gdxGame.assetsAll.listPuzzle[3], 4000,  40 , 4 ),
        Puzzle("\"Warehouse Collapse Puzzle\"",     gdxGame.assetsAll.listPuzzle[4], 5000,  50 , 5 ),
        Puzzle("\"Rooftop Smash Puzzle\"",          gdxGame.assetsAll.listPuzzle[5], 6000,  60 , 6 ),
        Puzzle("\"Living Boxes Puzzle\n\"",         gdxGame.assetsAll.listPuzzle[6], 7000,  70 , 7 ),
        Puzzle("\"Lift Platform Disaster Puzzle\"", gdxGame.assetsAll.listPuzzle[7], 8000,  80 , 8 ),
        Puzzle("\"Harbor Mayhem Puzzle\"",          gdxGame.assetsAll.listPuzzle[8], 9000,  90 , 9 ),
        Puzzle("\"Final Rush Puzzle\"",             gdxGame.assetsAll.listPuzzle[9], 10000, 100, 10),
    )
    ...
    private val parameter42 = TypefaceConfig().setCharacters(TypefaceConfig.CharType.ALL).setSize(42)
    private val parameter52 = TypefaceConfig().setCharacters(TypefaceConfig.CharType.ALL).setSize(52)
    private val parameter62 = TypefaceConfig().setCharacters(TypefaceConfig.CharType.ALL).setSize(62)
    ...
    private val lsB_42 = Label.LabelStyle(font42, ColorPalette.black_09)
    private val lsW_42 = Label.LabelStyle(font42, ColorPalette.white_FE)
    private val ls52 = Label.LabelStyle(font52, ColorPalette.black_09)
    private val lsW_62 = Label.LabelStyle(font62, ColorPalette.white_FE)
    private val lsG_62 = Label.LabelStyle(font62, ColorPalette.green_CC)
    ...
    private val btnGet = LabelButton(screen, "GET", ls52)
    ...
    private val scroll            = ScrollablePanel(horizontalGroup)
