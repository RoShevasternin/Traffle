...
package com.novaburst.pixelrally.game.utils.actor
...
fun Actor.setBoundsScaled(sizeScaler: DimensionCalculator, x: Float, y: Float, width: Float, height: Float) {
    setBounds(sizeScaler.scaled(x), sizeScaler.scaled(y), sizeScaler.scaled(width), sizeScaler.scaled(height))
}

fun Actor.setBoundsScaled(sizeScaler: DimensionCalculator, position: Vector2, size: Vector2) {
    setBoundsScaled(sizeScaler, position.x, position.y, size.x, size.y)
}

fun Actor.setSizeScaled(sizeScaler: DimensionCalculator, width: Float, height: Float) {
