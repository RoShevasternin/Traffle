...
class APanelSelectInapp(override val screen: DisplayScreen): ComponentGroup() {
    ...
    private val parameter60 = TypefaceConfig().setCharacters(TypefaceConfig.CharType.NUMBERS.chars + ".$").setSize(60)

    private val font60 = screen.fontGenerator_Regular.generateFont(parameter60)

    private val ls60 = Label.LabelStyle(font60, ColorPalette.black_09)
    ...
    private val btnBuy = LabelButton(screen, currentInapp.price, ls60)
