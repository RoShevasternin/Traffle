...
import com.novaburst.pixelrally.game.utils.TextureEmpty
...
import com.novaburst.pixelrally.game.utils.region

open class InteractiveButton(
    ...
    var touchDownBlock   : InteractiveButton.(x: Float, y: Float) -> Unit = { _, _ -> }
    var touchDraggedBlock: InteractiveButton.(x: Float, y: Float) -> Unit = { _, _ -> }
    var touchUpBlock     : InteractiveButton.(x: Float, y: Float) -> Unit = { _, _ -> }
