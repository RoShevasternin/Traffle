...
import com.gorillaz.puzzlegame.game.actors.main.AMainSettings
...
import com.gorillaz.puzzlegame.game.utils.TextureEmpty
...
import com.gorillaz.puzzlegame.game.utils.region
...
open class AButton(
    ...
    private fun getListener() = object : InputListener() {
        ...
        override fun touchDown(event: InputEvent?, x: Float, y: Float, pointer: Int, button: Int): Boolean {
            ...
            if (APanelSettings.isVibration) Gdx.input.vibrate(75)
