...
import com.colderonetrains.battlesskates.game.actors.main.AMainAchievements
...
class AchievementsScreen: AdvancedMainScreen() {

    private val aBackground = ABackground(this, gdxGame.currentBackground)
    override val aMain      = AMainAchievements(this)

    override fun AdvancedStage.addActorsOnStageBack() {
        addAndFillActor(aBackground)
        aBackground.animToNewTexture(gdxGame.assetsAll.BACKGROUND_BLUE, TIME_ANIM_SCREEN)
    }
