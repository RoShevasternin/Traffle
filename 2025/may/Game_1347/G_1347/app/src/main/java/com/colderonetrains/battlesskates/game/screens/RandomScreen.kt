...
class RandomScreen: AdvancedMainScreen() {

    private val aBackground = ABackground(this, gdxGame.currentBackground)
    override val aMain      = AMainRandom(this)

    override fun AdvancedStage.addActorsOnStageBack() {
        addAndFillActor(aBackground)
        aBackground.animToNewTexture(gdxGame.assetsAll.BACKGROUND_RANDOM, TIME_ANIM_SCREEN)
    }
